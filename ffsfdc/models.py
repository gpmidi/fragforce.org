...
class Donation(models.Model):
    ...
    systemmodstamp = models.DateTimeField(blank=True, null=True)
    lastmodifiedby = models.CharField(max_length=18, blank=True, null=True)
    lastactivity = models.DateField(blank=True, null=True)
    islocked = models.BooleanField(blank=True, null=True)
    createddate = models.DateTimeField(blank=True, null=True)
    createdby = models.CharField(max_length=18, blank=True, null=True)
