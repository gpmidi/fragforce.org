...
class BaseSFDCModel(models.Model):
    ...
    systemmodstamp = models.DateTimeField(blank=True, null=True)
    lastmodifiedby = models.CharField(db_column="lastmodifiedbyid", max_length=18, blank=True, null=True)
    lastactivity = models.DateField(db_column="lastactivitydate", blank=True, null=True)
